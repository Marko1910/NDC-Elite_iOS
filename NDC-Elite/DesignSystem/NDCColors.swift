...
enum NDCColor {
    ...
    /// Superficie reforzada — tarjetas bento de stats (#E2E2E7)
    static let surfaceStrong = Color(hex: 0xE2E2E7)
    /// Texto/icono dorado oscuro sobre el amarillo de acento (#756100)
    static let onAccent = Color(hex: 0x756100)
    /// Texto claro (celeste pálido) sobre tarjetas Celeste Oscuro (#C8E6FF)
    static let primaryFixed = Color(hex: 0xC8E6FF)
